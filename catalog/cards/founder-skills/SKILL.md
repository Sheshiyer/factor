---
name: founder-skills
description: "founder-skills. Founder skills from the 20-skill stack."
version: 0.1.0
author: Thoughtseed
license: MIT
metadata:
...
Founder skills from the 20-skill stack.

Load this only when `connectors/enabled.yaml` lists `founder-skills`.
...
1. Load `connector-gate` and confirm `founder-skills` is enabled.
